...
def test_required_integration_files_exist() -> None:
    expected = {
        ...
        "coordinator.py",
            ...
            "filtration_live_delivery.py",
            "filtration_runtime.py",
            "external_change_runtime.py",
        "grid_outage_delivery.py",
        "grid_outage_runtime.py",
...
def test_manifest_declares_safe_single_entry_config_flow() -> None:
    ...
    assert manifest["requirements"] == [
        "poolos@git+https://github.com/davidabuch/poolos.git@v0.11.10",
        "pyintellicenter==0.1.20",
    ]
    assert manifest["version"] == "0.11.10"
