...
def test_known_good_baselines_are_configurable_and_not_gpm_based() -> None:
    ...
    assert (values.temperature_probe_rpm, values.grid_outage_rpm, values.filtration_rpm, values.solar_heating_rpm, values.gas_heating_rpm) == (1500, 1500, 2600, 2900, 3000)
