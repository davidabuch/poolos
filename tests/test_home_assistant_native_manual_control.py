...
def test_manual_gateway_exposes_only_explicit_manual_operations() -> None:
    ...
    assert "async def async_set_body_heat_source(" in source
    assert "async def async_set_intellichlor_output(" in source
...
def test_manual_gateway_uses_pyintellicenter_supported_write_methods() -> None:
    ...
    assert 'thermal_body == "hot_tub"' in source
