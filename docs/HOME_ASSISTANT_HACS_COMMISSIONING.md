...
Patch release `0.10.2` packages the Pool-only commissioning milestone through PR #134, including post-thermal circulation cleanup, Pool Solar temperature-probe execution, and default-off confirmed-grid-outage physical safety, and pins the core dependency to matching tag `v0.10.2` for HACS delivery.
